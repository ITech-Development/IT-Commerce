...
const Card = () => {
  ...
  return (
    <div className="card flex">
      <img
        src="https://image.pngaaa.com/123/2193123-middle.png"
        alt=""
      ...
      <img
        src="https://png.pngtree.com/png-clipart/20210312/original/pngtree-simple-medal-of-honor-linear-icon-png-image_6074699.png"
        alt=""
        className="card-image"
        width="200px"
        height="100px"
      ...
      <div className="card-content">
        ...
        <p className="card-description">Description points</p>
        <h4 className="total-points">your point here, Points</h4>
      </div>
    </div>
  );
};
