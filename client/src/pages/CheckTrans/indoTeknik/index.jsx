...
function Index() {
  const { data: carts } = useGetCartsIndoTeknikQuery()
  ...
  const handlePaymentProcess = async (data) => {
    ...
    const response = await axios({
      url: `https://indoteknikserver-732012365989.herokuapp.com/midtrans/indo-teknik`,
      params,
      data: {
        carts,
        checkoutProvince,
  ...
  useEffect(() => {
    ...
    scriptTag.setAttribute("data-client-key-indo-teknik", midtransClientKey);
