          ...
          {checkoutProducts.map((checkoutProduct, index) => (
            <tr key={index}>
              <td>
                ...
                <p>Berat: {checkoutProduct.product.weight} gr</p>
              </td>
              <td>{checkoutProduct.quantity}</td>
              <td>{formatPrice(checkoutProduct.product.unitPrice)}</td>
              <td>
                
              {formatPrice(checkoutProduct.quantity * checkoutProduct.product.unitPrice)}
              </td>
        ...
        <div className="sec3Right">
          <div className="contentSec31">
            ...
            <p className="dataInvoice1">
              {formatPrice(calculateTotalPrice(checkoutProducts))}
            </p>
          </div>
          <div className="contentSec3">
            ...
            <p className="dataInvoice1">
              {formatPrice(checkoutProducts[0].checkout.shippingCost)}
            </p>
          </div>
          <div className="contentSec3">
          ...
          <div className="contentSec3">
            ...
            <p className="dataInvoice1">
              {formatPrice(calculateTotalDiscount(checkoutProducts))}
            </p>
          </div>
          <div className="contentSec3">
          ...
          <div className="contentSec3">
            ...
            <p className="dataInvoice1">
              {formatPrice(checkoutProducts[0].checkout.setPPN)}
            </p>
          </div>
          <div className="content1Sec3">
            <p className="dataInvoice1Total">TOTAL BELANJA</p>
            <p className="dataInvoice1">
              {formatPrice(checkoutProducts[0].checkout.totalPrice)}
            </p>
          </div>
